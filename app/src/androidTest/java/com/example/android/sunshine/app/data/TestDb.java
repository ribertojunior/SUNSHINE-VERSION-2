...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long in = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,null, cv);
        assertTrue("Error: Insertion in weather table has fail.", in != -1 );
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: The returning cursor is not equals to ContentValues inserted.", c, cv);
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        long in = db.insert(WeatherContract.LocationEntry.TABLE_NAME,null, cv);
        assertTrue("Error: Insertion in location table has fail.", in != -1 );
        // Query the database and receive a Cursor back
